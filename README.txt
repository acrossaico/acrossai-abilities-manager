...
* **Every ability now has a toolset.** WordPress core's own abilities are placed individually (site and environment info under Diagnostics, user info under Users), and anything unrecognised falls to a new **Other** toolset rather than disappearing. The tab counts now sum to the "All" total, which they did not before.
