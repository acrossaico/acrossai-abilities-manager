...
require_once dirname( __DIR__, 4 ) . '/includes/Abilities/Integrations/WPCode.php';
require_once dirname( __DIR__, 4 ) . '/includes/Abilities/Integrations/Loco_Translate.php';
