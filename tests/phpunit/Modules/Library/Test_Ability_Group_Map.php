...
class Test_Ability_Group_Map extends TestCase {
	...
	private function abilities(): array {
		$skip = array( 'Acf', 'Elementor', 'RankMath', 'ContactForm7', 'LiteSpeed', 'Yoast', 'ClassicEditor', 'WPCode', 'LocoTranslate', 'EventsCalendar', 'EventTickets', 'Integrations', 'Utilities', 'Rest' );
		$out  = array();
