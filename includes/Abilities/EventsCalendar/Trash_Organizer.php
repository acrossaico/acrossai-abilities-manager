...
/**
 * events/trash-organizer — Trash Organizer.
 */
final class Trash_Organizer extends Base_Events_Calendar_Ability {

	protected function slug(): string {
		return 'events/trash-organizer';
	}

	protected function ability_label(): string {
		return __( 'Trash Organizer', 'acrossai-abilities-manager' );
	}

	protected function ability_description(): string {
		return __(
			'Move a organizer to the trash. Reports how many events still point at it first — the calendar does not clear those links, so they would be left referencing a trashed post. Trash only, never permanent deletion.',
	...
	protected function run( array $input ) {
		...
		$linked  = Event_Repository::linked_event_count( $id, 'organizer' );
