<?php
/**
 * Feature 071 — update an existing wp_navigation entity.
 *
...
/**
 * Update title, content, or status of an existing wp_navigation post.
 */
class Update_Navigation extends Ability_Definition {
	...
	public function execute( array $input = array() ): array {
		...
		return array(
			...
			'message' => sprintf( __( 'Navigation #%d updated.', 'acrossai-abilities-manager' ), $id ),
		);
	}
