<?php
/**
 * Feature 075 — generate a dynamic core/query section from a recipe.
 *
...
/**
 * Generate a dynamic core/query section from a query-recipe ID + input.
 */
class Generate_Query_Section extends Ability_Definition {
	...
	protected function ability(): array {
		return array(
			'name' => 'blocks/generate-query-section',
			'args' => array(
